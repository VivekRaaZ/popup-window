...
const portifolioData = [
  {
    ...
    liveLink: 'https://github.com/VivekRaaZ/portfolio',
    sourceLink: 'https://github.com/VivekRaaZ/portfolio',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description1:
      'Exploring the future of image in Facebooks first Virtual Reality app; a place to discover and enjoy 360 photos and videos on Gear VR.',
    description2:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essent',
    featuredImage: '',
    technologies: ['HTML', 'Ruby on rails', 'CSS', 'Javascript'],
...
portifolioData.forEach((data) => {
  worksHtml += `  <div class="work-item lg-screen">
          <img src="./image/${data.imageName}" class="work-image"/>
    ...
    .join('')}
            ...
            <button class="work-link" type="button" data-work-array='${JSON.stringify(data)}'>
  ...
  seeProjectButtons.forEach((button) => {
      ...
      modalHtml = ` <div class="modal-container">
          <div class="head">
            ...
            <button class="closePopup">
              <img src="./image/Disabled.png" alt="">
            </button>
          </div>
          <div class="contentimg">
            <img src="./image/${workArray.imageName}" alt="">
          </div>
          <div class="details">
            <p>
              <span>
    ...
    .join('')}
              ...
              <a href="${workArray.liveLink}" target="_blank">
                <button>
                  See live 
                  <img src="./image/Icon - Export.svg" alt="">
                </button>
                </a>
